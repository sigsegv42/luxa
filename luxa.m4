# additional m4 rules
# config.nice support lifted from Apache APR (LUXA_EXPAND_VAR & LUXA_CONFIG_NICE)
#
...
dnl bar='${foo}/2'
dnl baz='${bar}/3'
dnl LUXA_EXPAND_VAR(fraz, $baz)
dnl   $fraz is now "1/2/3"
dnl 
AC_DEFUN([LUXA_EXPAND_VAR],[
ap_last=
ap_cur="$2"
...
dnl LUXA_CONFIG_NICE(filename)
dnl
dnl Saves a snapshot of the configure command-line for later reuse
dnl
AC_DEFUN([LUXA_CONFIG_NICE],[
  rm -f $1
  cat >$1<<EOF
#! /bin/sh
#
